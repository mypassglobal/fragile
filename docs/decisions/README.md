...
| [0070](0070-support-load-context-metric-and-trend-sparklines.md) | Support Load as a context metric (per-team % + count + trend, org = mean of team %s), excluded from health score; kanban uses board-wide completed basis (amended 2026-07-30); Recharts trend sparklines; Health Check section separation | Accepted | 2026-07-28 |
